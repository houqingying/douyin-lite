...
import (
	video "github.com/houqingying/douyin-lite/protobuf/grpc_gen/video"
...
type FavoriteActionRequest struct {
	...
	ActionType int32  `protobuf:"varint,4,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty"` // 1: favorite, 2: cancel favorite
}
...
type FavoriteActionResponse struct {
	...
	StatusCode int32  `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // 0: success, other: failed
...
var file_favorite_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x6f, 0x75, 0x71, 0x69, 0x6e, 0x67,
	0x79, 0x69, 0x6e, 0x67, 0x2f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2d, 0x6c, 0x69, 0x74, 0x65,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x67,
	0x65, 0x6e, 0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x3b, 0x66, 0x61, 0x76, 0x6f,
